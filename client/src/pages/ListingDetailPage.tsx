      ...
      <div className="grid md:grid-cols-2 gap-6 lg:gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-lg border border-gray-200 text-sm font-medium text-gray-700 hover:bg-green-50 hover:border-green-300 hover:text-green-800 transition-colors"
          >
